...
export default function InventoryView({ 
  ...
  const handleUpdateStock = (id: number, delta: number) => {
    if (user && user.planStatus !== 'active' && user.planStatus !== 'trialling') {
      alert(`Ação Bloqueada! A conta de ${user.name} está com assinatura inativa. Reative seu plano comercial para alterar o estoque.`);
      return;
    }
    alert("Email de aviso enviado ao administrador sobre a alteração do produto.");
  ...
  const handleDelete = (id: number) => {
    if (user && user.planStatus !== 'active' && user.planStatus !== 'trialling') {
      alert(`Ação Bloqueada! A conta de ${user.name} está com assinatura inativa. Reative seu plano comercial para excluir produtos.`);
      return;
    }
    alert("Email de aviso enviado ao administrador sobre a exclusão do produto.");
