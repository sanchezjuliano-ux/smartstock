        ...
        >
          ...
          <div className="overflow-y-auto p-6">
            ...
            {user && user.planStatus !== 'active' && user.planStatus !== 'trialling' && (
              <div className="mb-4 bg-error-container text-on-error-container border border-error/20 p-4 rounded-xl flex items-start gap-3 shadow-sm animate-in fade-in slide-in-from-top-2 duration-300">
                <span className="material-symbols-outlined text-error text-2xl select-none">block</span>
                <div>
                  <h4 className="font-bold text-xs text-error tracking-tight">Escrita Bloqueada</h4>
                  <p className="text-[11px] opacity-90 mt-0.5 leading-relaxed">
                    A conta <b>{user.name}</b> está com a assinatura inativa. Ative o plano comercial nas configurações do perfil para poder adicionar ou editar itens.
                  </p>
                </div>
              </div>
            )}
